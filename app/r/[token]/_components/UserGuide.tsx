      ...
      <div className="border-t border-blue-200 px-5 py-5 space-y-6 text-sm">
        ...
        <Section step="1" title="まず最初に：基本受取方式を選びましょう">
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>
              <b>繰延受取（翌年以降）</b>：受取りを翌年以降にずらすことで、増額された金額を受け取れる方式。
            </li>
          </ul>
        ...
        <Section step="3" title="サマリーカードを読む">
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>
              <b>見込み（青いカード）</b>：まだ確定前のトスアップ案件で「もしこのまま確定したら入る予定の金額」。あなたの取り分が反映済み
            </li>
            <li>
        ...
        <Section step="4" title="「あなたへの配分」テーブルで案件ごとの取り分を確認">
          <p>確定した案件ごとに、あなたへの配分金額が並びます。</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>
              <b>即時／繰延</b>の金額が両方表示され、現在選択中の方が太字でハイライト
            </li>
            <li>
